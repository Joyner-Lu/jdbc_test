...
/**
 * 测试SetFetchSize是否真的可以一批一批的去读取数据，运行该程序，PreparedStatement的resultSetType设置为TYPE_SCROLL_INSENSITIVE
 ...
 * 结论：可以，确实是一批一批的去读取的。
 */
public class JDBCTestSetFetchSizeInsensitive {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                ThreadUtil.sleepSecond(1);//休息1秒，方便查看抓包数据
            }
        } catch (Exception ex) {
            ex.printStackTrace();
        } finally {
